...
dsconfigad -add "unishanoi.org" -username "tcatech@unishanoi.org" -password "edu12345a@" -alldomains enable -mobile enable -mobileconfirm disable -preferred dc2.unishanoi.org -localhome enable -ou "OU=Macs,OU=UNIS Computers,DC=UNISHANOI,DC=ORG" -group "UNISHANOI\Domain Admins,UNISHANOI\Tech Support" -force
sleep 3
